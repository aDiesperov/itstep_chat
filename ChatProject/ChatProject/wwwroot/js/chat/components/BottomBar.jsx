    ...
    render() {
        return (
            <div id="bottom-bar">
                ...
                <ModalAddContact />
                <ModalSettings deleteParticipant={this.props.deleteParticipant} leaveChat={this.props.leaveChat} chatInfo={this.props.chatInfo} selectedChat={this.props.selectedChat} />
            </div>
            );
    }
}